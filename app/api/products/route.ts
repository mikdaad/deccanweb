...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.log(`Raw Params: search='${search}', subcategory='${subcategoryParam}', category='${categoryParam}', status='${statusParam}', sort='${sortFilter}', minPrice='${minPriceParam}', maxPrice='${maxPriceParam}', ispremium='${isPremiumParam}'`);
