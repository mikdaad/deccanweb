...
<div className='relative flex flex-col'>
    ...
    <div  style={{ 
        ...
        <header className="sticky  top-0 w-full h-16 bg-transparent shadow-md my-4 z-20">
          <HeaderNavigation />
        </header>
      ...
      <div className={`${styles.Ellipse_2_176_209} absolute z-0 right-3/4 overflow-hidden`}></div>
      <div className={`${styles.Ellipse_2_176_210} absolute z-0 bottom-3/4 left-3/4 overflow-hidden`}></div>
        <span className={`${styles.YourMostModernHomeWithOurProducts_176_223} font-serena `}>YOUR MOST MODERN HOME WITH OUR PRODUCTS</span>
       {/* Styled Paragraph */}
       <p className="text-[rgba(255,255,255,0.70)] font-[Inter] text-[20px] font-thin leading-[150.07%] whitespace-pre-line max-w-[40%] mt-4">
        ...
        <div className={`${styles.Group_5369_176_226} absolute right-2`}><svg width="105" height="333" viewBox="0 0 117 353" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            <clipPath id="bgblur_0_176_226_clip_path" transform="translate(54 54)">
...
<div className={`${styles.Frame_5408_176_206} ml-24 `}><span className={styles.ViewProducts_176_207}>View Products</span></div>
...
<div >
  ...
  <div className="relative max-w-[589px] min-h-[365px] rounded-[12px] overflow-hidden">
  <div className="bg-gradient-to-r from-[#E8AF52] via-yellow-700 to-[#225043] hover:bg-gradient-to-l inset-3 rounded-[5px] p-[2px] text-white duration-300 hover:shadow-2xl hover:shadow-purple-600/30    ">
  <div className='bg-black p-1'> <img src="/banner/b5.png" alt="Heritage Image" className="w-full h-full object-cover" />
  </div>
  </div>
</div>

   <div className='flex flex-col max-w-[80%]'> <span className={styles.ExperienceThePerfectBlendOfHeritage_176_357}>Experience the Perfect Blend of Heritage </span><span className={styles.ExperienceThePerfectFusionOfTraditionAndModernityWithTheUsAddATouchOfOpulenceToYourHomeAndLetYourDécorTellAStoryOfEleganceYourHomeAndLetYourDécorTellAStoryOfEleganceYourHomeAndLetYourDécorTellAStoryOfElegance_176_358}>Experience the perfect fusion of tradition and modernity with the us. Add a touch of opulence to your home and let your d&#xE9;cor tell a story of elegance.
      your home and let your d&#xE9;cor tell a story of elegance.your home and let your d&#xE9;cor tell a story of elegance.</span> </div>

      </div>

       <div className=' flex flex-row justify-around mb-10'>

       <div className='flex flex-col max-w-[50%]'> <span className={styles.ExperienceThePerfectBlendOfHeritage_176_357}>Experience the Perfect Blend of Heritage </span><span className={styles.ExperienceThePerfectFusionOfTraditionAndModernityWithTheUsAddATouchOfOpulenceToYourHomeAndLetYourDécorTellAStoryOfEleganceYourHomeAndLetYourDécorTellAStoryOfEleganceYourHomeAndLetYourDécorTellAStoryOfElegance_176_358}>Experience the perfect fusion of tradition and modernity with the us. Add a touch of opulence to your home and let your d&#xE9;cor tell a story of elegance.
       your home and let your d&#xE9;cor tell a story of elegance.your home and let your d&#xE9;cor tell a story of elegance.</span> </div>

  <div className="relative max-w-[589px] min-h-[365px] rounded-[12px] overflow-hidden">
  <div className="bg-gradient-to-r from-[#E8AF52] via-yellow-700 to-[#225043] hover:bg-gradient-to-l inset-3 rounded-[5px] p-[2px] text-white duration-300 hover:shadow-2xl hover:shadow-purple-600/30    ">
  <div className='bg-black p-1'> <img src="/banner/b6.png" alt="Heritage Image" className="w-full h-full object-cover" />
  </div>
  </div>
</div>
      ...
      <HeroSection/>
      <div className={`${styles.Ellipse_13_176_203} absolute top-0 left-56 z-0`}></div>
